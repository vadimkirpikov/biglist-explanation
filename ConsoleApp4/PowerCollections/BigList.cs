...
namespace Wintellect.PowerCollections
{
    ...
    public class BigList<T>: ListBase<T>, ICloneable
    {
...
#if DEBUG
        const int MAXLEAF = 4;                  // Maximum number of elements in a leaf node -- small for debugging purposes.
#else
        const int MAXLEAF = 120;               // Maximum number of elements in a leaf node. 
#endif
        const int BALANCEFACTOR = 3;      // how far the root must be in depth from fully balanced to invoke the rebalance operation (min 3).
        ...
        public int FibDepth {get => FIBONACCI[root.Depth];}
        public int FidRootDepth {get => FIBONACCI[root.Depth-BALANCEFACTOR];}
        public int CountBalanced {get => _countBalanced;}
        private int _countBalanced = 0;
        ...
        private abstract class Node
        {
            ...
            /// <summary>
            ///   a node before this node. Never changes this node, but returns
